...
export default async function handler(req, res) {
    ...
    try {
        console.log(`📊 Récupération enregistrements groupes pour apprenant ${apprenantId}`)

        // ====================================================================
        // 2. RÉCUPÉRER TOUS LES ENREGISTREMENTS DE GROUPES DE L'APPRENANT
        // ====================================================================
        ...
        if (error) {
            console.error('❌ Erreur récupération enregistrements groupes:', error)
        ...
        console.log(`✅ ${enregistrements?.length || 0} enregistrement(s) groupe(s) trouvé(s)`)
        ...
        // ====================================================================
        // 4. CRÉER UN INDEX PAR GROUPE_SENS_ID POUR ACCÈS RAPIDE
        // ====================================================================

        const enregistrementsMap = {}
        enregistrementsWithSignedUrls.forEach(enreg => {
            enregistrementsMap[enreg.groupe_sens_id] = enreg
        })
