...
export default async function handler(req, res) {
    ...
    try {
        console.log(`🗑️ Suppression enregistrement mot ${enregistrementId} par apprenant ${apprenantId}`)
        ...
        console.log('✅ Enregistrement trouvé:', enregistrement.mot, '-', enregistrement.audio_url)
