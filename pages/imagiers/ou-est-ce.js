            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{
                        ...
                        Écoutez le mot et trouvez l'image correspondante
                    </p>
                    ...
                    {imagiers.length > 0 && (
                        <div style={{
                            ...
                            <label style={{
                                ...
                                🎯 Nombre d'images proposées par question
                            </label>
                            <select
                    ...
                    {imagiers.length === 0 ? (
                        <div style={{
                            ...
                            <h3 style={{ marginBottom: '15px', color: '#4338ca' }}>
                                Aucun imagier disponible
                            </h3>
                            <p style={{ color: '#6366f1', marginBottom: '25px' }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: 'clamp(16px, 3vw, 18px)', fontWeight: 'bold', color: '#4338ca' }}>
                    ...
                    <div style={{
                        ...
                        <h2 style={{
                            ...
                            {currentQuestion.correctAnswer.mot}
                        </h2>

                        <button
                            onClick={() => speakText(currentQuestion.correctAnswer.mot, selectedImagier.voix || 'Paul')}
                            style={{
                                backgroundColor: '#6366f1',
                                color: 'white',
                                padding: '15px 30px',
                    ...
                    <div style={{
                        ...
                        gap: '10px',
                        marginBottom: '20px',
                        maxWidth: `${Math.ceil(Math.sqrt(currentQuestion.options.length)) * 150}px`,
                        ...
                        {currentQuestion.options.map((option, index) => {
                            ...
                            let borderWidth = '3px'
                            let boxShadow = '0 4px 15px rgba(0,0,0,0.1)'
                            let opacity = 1

                            if (answered) {
                                // Si c'est l'image sélectionnée
                                if (isSelected) {
                                    if (isCorrect) {
                                        // Bonne réponse : vert
                                        borderColor = '#10b981'
                                ...
                                // Si c'est la bonne réponse (même si non sélectionnée)
                                else if (isCorrect) {
                                    borderColor = '#10b981'
                                    borderWidth = '5px'
                                    boxShadow = '0 0 25px rgba(16, 185, 129, 0.6)'
                                }
                                // Autres images : on les grise
                                else {
                                    opacity = 0.4
                                }
                            }
