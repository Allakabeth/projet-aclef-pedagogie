...
export default function ReconnaitreLesMotsPage() {
    ...
    const [decoupageValidation, setDecoupageValidation] = useState(null) // { correct: boolean, positionsAttendues: [], motsAttendus: [] }
                    ...
                    {(() => {
                        ...
                        return groupes.map((groupe, groupeIndex) => {
                            ...
                            if (decoupageValidation && !decoupageValidation.correct) {
                                ...
                                // Appliquer bordure verte ou rouge (pas de fond coloré)
                                if (estCorrect) {
